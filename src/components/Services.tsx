    ...
    <section id="services" className="py-16 md:py-32 bg-alabaster text-charcoal relative overflow-hidden border-t border-neutral-200/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col gap-8">
          ...
          <Link href={featuredService.link} className="block w-full">
            <motion.div
              className="w-full bg-transparent border border-[#C5A880]/30 p-10 flex flex-col justify-between relative overflow-hidden min-h-[200px] group transition-all duration-[0.8s] ease-editorial hover:border-[#C5A880]/60 cursor-pointer"
            ...
            >
              <div className="flex flex-col gap-6 h-full justify-between">
                ...
                <div className="relative z-10 pt-4 md:pt-0 text-left flex-shrink-0">
                  <span className="inline-flex items-center gap-1 font-sans text-xs tracking-widest font-bold uppercase text-charcoal group-hover:text-champagne-gold transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {remainingServices.map((service, index) => (
              <Link key={index} href={service.link} className="block h-full">
                <motion.div
                  className="bg-transparent border border-neutral-200/40 p-10 flex flex-col justify-between group transition-all duration-[0.8s] ease-editorial hover:border-[#C5A880]/50 min-h-[300px] h-full cursor-pointer"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
          ...
          >
            <Link
              href="/services"
              className="inline-flex items-center justify-center gap-2 bg-[#111111] hover:bg-champagne-gold text-white hover:text-charcoal border border-[#111111] hover:border-champagne-gold font-sans font-bold text-xs tracking-widest uppercase px-9 py-4 rounded-sm transition-all duration-300 group shadow-sm hover:shadow-md"
            >
              View All
